...
#' @export
#'
#' @param mdata a dataframe containing the target experiment metadata, as generated by identify_dataset
#' @param sdata a dataframe containing the target summary observed data, as generated by identify_dataset
